...
function FilterForm({ applyFilter, disable, activated }) {
  ...
  const changeProp = (e) => {
    ...
    else setFilter({ ...filter, prop: e.target.value });
  };
            ...
            {filter.prop !== "lastmessage" ? (
              ...
              <>
                ...
                <Form.Control
                  type="datetime-local"
                  placeholder="Valor"
                  value={filter.value.inicial}
                  onChange={(e) => {
                    setFilter({
                      ...filter,
                      value: { ...filter.value, inicial: e.target.value },
                    });
                  }}
                  required
                />
                ...
                <Form.Control
                  type="datetime-local"
                  placeholder="Valor"
                  value={filter.value.final}
                  onChange={(e) => {
                    setFilter({
                      ...filter,
                      value: { ...filter.value, final: e.target.value },
                    });
                  }}
                  required
                />
